...
# <div align="center">Приложение-интерактив "Георический маршрут"</div>  
...
```
cd existing_repo
git remote add origin https://gitlab.com/Shilov_DO/kostroma_geroicheskaya.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Shilov_DO/kostroma_geroicheskaya/-/settings/integrations)
